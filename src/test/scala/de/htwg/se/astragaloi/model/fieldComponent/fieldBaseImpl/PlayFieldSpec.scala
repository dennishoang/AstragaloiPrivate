...
class PlayFieldSpec extends AnyWordSpec {
    ...
    "A PlayField" should {
        ...
        "insert values" in {
            ...
            val playfield10 = playfield9.insertValue(0, 0, Dice.TWO, Dice.Empty, 0, oldIndexes)
        ...
        "undo inputs" in {
            ...
            val oldIndexes = Vector[Int]()
            playfield9 = playfield9.insertValue(0, 0, Dice.TWO, Dice.Empty, 0, oldIndexes) // with do
            playfield9 = playfield9.insertValue(0, 0, Dice.TWO, Dice.Empty, 1, oldIndexes) // with undo
